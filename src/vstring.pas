...
@2:
       ...
       CMP AL,'п'
       JA  @3
       AND AL,0DFH      { Convert chars "абв...п" }
        JMP     @1
@3:
       CMP AL,'р'
       JB  @1
       ...
       CMP AL,'я'
       JA  @4
       SUB AL,050H      { Convert chars "рст...я" }
        JMP     @1
@4:
       CMP AL,'ё'
       JNE @1
...
@2:
       ...
       CMP AL,'П'
       JA  @3
       ADD AL,20H      { Convert chars "абв...п" }
        JMP     @1
@3:
       CMP AL,'Р'
       JB  @1
       ...
       CMP AL,'Я'
       JA  @4
       ADD AL,050H      { Convert chars "рст...я" }
        JMP     @1
@4:
       CMP AL,'Ё'
       JNE @1
...
begin
   ...
   If s <> '' then begin
      ...
      If (n >= 0) then begin {если искомая строка целиком умещается в буфере}
         Inc(n);
         ix := 0;
         iy := 0;
         OldPointer:=buf;
